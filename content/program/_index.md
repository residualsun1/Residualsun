...
「项目」是我为研究生阶段开辟的生活指南栏目，将主要通过阅读、写作、参与行动甚至是搭建网站的方式来展开执行。就目前我的个人能力与状态而言，写作是最为直接也最为迫切的积累，我会基于阅读、实践的基础形成相关项目主题的文章，写作完成后集合于项目的「详细内容」中，方便查阅，并希望在日后能对此进行梳理与总结，形成体系，进而探索下一步的行动。

所有的项目都处于变化和流动的状态，并非一成不变。

## 项目一：海洋、岛屿与渔业的人类学

{{% notice content "简介" %}}

如果说田野调查是人类学学习者的成人之礼，那么我的人类学从一开始就与海岛与岛屿密不可分。2023 年，在利兵老师的推荐下，我独自前往湛江市硇洲岛西埠村展开了田野调查，后续再次返回，完成了本科毕业论文。

回顾本科进行的田野调查，有许多不足，也有不少遗憾。但在整理田野资料的过程中，我发现或许还有更多挖掘和探索的空间……

{{% /notice%}}

<details> <summary>详细内容</summary>

### 阅读 

1. 王利兵，2022-04-14，「岛屿人类学漫游︱硇洲岛，一个开放的离岛社会」，澎湃思想市场，https://www.thepaper.cn/newsDetail_forward_17281855
2. 王利兵，2022-02-01，「岛屿人类学漫游｜南澳岛，一半火焰一半海水」，澎湃思想市场，https://m.thepaper.cn/newsDetail_forward_16271218

### 写作

### 海洋人类学的数据库

按照兵哥的需求，需要搭建一个可以登录的数据库网站，但他的需求似乎还不十分明确，我可能得自己搭建出一个雏形后再慢慢增加不同的要素和功能，进而和他继续明确需求……
...
对前端的学习兴趣发端于个人网站的建立。当下我还在跟随 Coderwhy 进行相对系统化的学习，从 HTML 开始，到 CSS，Javascript，希望之后能一直学到 Vue 与 React。
...
## 项目三：R 语言 CGSS 数据分析笔记（待定）

{{% notice content "简介" %}}
说来十分惭愧，本科期间在谢颖老师的鼓励下，我在 20 级的学长学姐们合作编写的 CGSS 数据分析 bookdown 笔记（<a>https://github.com/residualsun1/deploy</a>）的基础上进行修改和重新发布，但其中的内容却仍然是粗糙而浅显的，我想~~若有机会~~应当重整旗鼓……
{{% /notice%}}
...
## 项目五：追寻良善的照护：何为照护，如何照护

{{% notice content "简介" %}}

我发现自己的阅读兴趣绕不过「照护」这一主题。事实上，或许正是因为「照护」本身与我的生活紧密结合——不论是我对父母在奶奶临终时期进行照护的见证，还是我对日后父母年老体衰的想象和忧虑，甚至是我已开始为自己的身体机能发展而进行的悲观想象，所有的这些都促使我希冀自己能真正形成「何为照护」的理解，以及在行动上学会「如何照护」。

这一项目的目标同样以阅读和写作的方式进行，而良好的写作或许最后需要脱胎于现实中的身体力行。
...
1. 安孟竹，2025-01-08，「Why we care？以及关于照护书写的征集 | 看理想 x 结绳志」，公众号：结绳志，https://mp.weixin.qq.com/s/jbfNwAY_1t-mh06fyaJ3LQ
...
* 春花，2023-06-06，散记 | 作为理论的田野调查，脂肪苦难，https://mp.weixin.qq.com/s/9tWIkkOOrA0FGOUYv0ecLQ
* 春花，转载于 2024-03-26，转载 | 【散记】有关研究与自我的碎碎念?，https://guozheng.rbind.io/posts/2024/03/research-and-myself/
